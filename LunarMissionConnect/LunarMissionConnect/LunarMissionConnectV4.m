...
stkexec(conid,'VO Scenario/LunarMissionConnect View FromTo FromToRegName "View Central Body" FromToName "Moon" WindowID 2');
...
% MCS sequence
stkexec(conid,'ASTROGATOR Scenario/LunarMissionConnect/Satellite/LunarProbe SETVALUE MainSEQUENCE.SegmentList Target_Sequence Target_Sequence return');
stkexec(conid,'ASTROGATOR Scenario/LunarMissionConnect/Satellite/LunarProbe SETVALUE MainSEQUENCE.SegmentList.Target_Sequence.SegmentList Launch Propagate Impulsive_Maneuver Propagate Propagate return');
stkexec(conid,'ASTROGATOR Scenario/LunarMissionConnect/Satellite/LunarProbe SETVALUE MainSEQUENCE.SegmentList.Target_Sequence1.SegmentList Impulsive_Maneuver Propagate return');
...
stkexec(conid,[propagatecommand 'StoppingConditions.Duration.TripValue 4 hours']);

% impulsive maneuver
maneuvercommand = ['ASTROGATOR Scenario/LunarMissionConnect/Satellite/LunarProbe SETVALUE MainSEQUENCE.SegmentList.Target_Sequence.SegmentList.Impulsive_Maneuver.'];
...
stkexec(conid,[targetcommand 'Impulsive_Maneuver Cartesian.X']);
...
stkexec(conid,[targetcommand4 'Impulsive_Maneuver Cartesian.X Active true']);
...
stkexec(conid,[targetcommand3 'Delta_Declination.Desired 0.0 km']);
stkexec(conid,[targetcommand3 'Delta_Right_Asc.Desired 0.0 km']);
...
stkexec(conid,[command 'Impulsive_Maneuver Cartesian.X Active true']);
...
stkexec(conid,[command 'BDotR.Desired 5000.0 km']);
...
% ***********************
% impulsive maneuver
maneuvercommand = ['ASTROGATOR Scenario/LunarMissionConnect/Satellite/LunarProbe SETVALUE MainSEQUENCE.SegmentList.Target_Sequence1.SegmentList.Impulsive_Maneuver.'];
stkexec(conid,[maneuvercommand 'AttitudeControl Thrust Vector']);
stkexec(conid,[maneuvercommand 'CoordType Cartesian']);
...
stkexec(conid,[command 'Impulsive_Maneuver Cartesian.X']);
stkexec(conid,[command 'Impulsive_Maneuver Cartesian.Y']);
% set active
...
stkexec(conid,[command 'Impulsive_Maneuver Cartesian.X Active true']);
stkexec(conid,[command 'Impulsive_Maneuver Cartesian.Y Active true']);
